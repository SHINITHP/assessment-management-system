...
export const AnimatedGroup = ({ children, className, variants, preset, as = 'div', asChild = 'div', }) => {
    ...
    return (_jsx(MotionComponent, { initial: "hidden", animate: "visible", variants: containerVariants, className: className, children: React.Children.map(children, (child, index) => (_jsx(MotionChild, { variants: itemVariants, children: child }, index))) }));
};
