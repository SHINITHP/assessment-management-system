...
export const AnimatedGroup: React.FC<AnimatedGroupProps> = ({
  ...
  const MotionComponent = useMemo(() => motion(as as string | React.ComponentType<any>), [as]);
  const MotionChild = useMemo(() => motion(asChild as string | React.ComponentType<any>), [asChild]);
